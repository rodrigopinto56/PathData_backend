...
@dag(
    ...
    description="Transforma Bronze -> Silver (limpieza, normalizacion, cuarentena)",
    schedule="@daily",
...
def transformacion_silver_dag():
    ...
    for fuente in FUENTES:
        ...
        ruta_bronze_local >> limpiar_y_normalizar >> subir_silver_a_minio(fuente, salida_silver)
